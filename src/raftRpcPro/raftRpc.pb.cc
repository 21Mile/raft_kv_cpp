...
const char descriptor_table_protodef_raftRpc_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Reply\022P\n\013RequestVote\022\037.raftRpcProctoc.Re"
  "questVoteArgs\032 .raftRpcProctoc.RequestVo"
  "teReply\022b\n\017InstallSnapshot\022&.raftRpcProc"
  "toc.InstallSnapshotRequest\032\'.raftRpcProc"
